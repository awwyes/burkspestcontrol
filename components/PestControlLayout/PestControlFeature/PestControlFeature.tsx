      ...
      <Box as="section" maxW="8xl" mx="auto" py="6" px={{ base: '6', md: '8' }}>
        ...
        <SimpleGrid columns={{ base: 1, md: 2 }} spacingX="10" spacingY={{ base: '8', md: '14' }} color={useColorModeValue("black", "yellow.500")}>
          ...
          <Feature title="Monitoring & Prevention" icon={<FcOk />}>
            As the seasons change, your home becomes more appealing to a variety of insects, spiders, and rodents. Your Cook's professional consistently monitors your home's protective barrier to make sure pests can't get in.
          </Feature>
        </SimpleGrid>
      </Box>
    </Flex>
